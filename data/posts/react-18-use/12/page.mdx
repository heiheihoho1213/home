---
title: '新版React官方文档解读（尾章）- 实验性功能'
slug: 'react-18-use-12'
date: '2023-11-09'
readTime: '10 min'
excerpt: '介绍 React 18 的 use、useOptimistic、useFormState、useFormStatus、cache、experimental_taintObjectReference、experimental_taintUniqueValue ...'
tags: ['React', 'React 18', '官方文档翻译']
---
