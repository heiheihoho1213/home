---
title: 'React Router v6 官方文档翻译 （七） ---- 内置API'
slug: 'react-router-6-built-in-api'
date: '2022-09-19'
readTime: '10 min'
excerpt: '介绍 React Router v6 的createRoutesFromChildren、createSearchParams、generatePath、Location、matchPath、matchRoutes、renderMatches、resolvePath等内置API ...'
