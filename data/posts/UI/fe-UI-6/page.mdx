---
title: '手把手搭建基于React的前端UI库 （六）-- 打包与发布'
slug: 'fe-UI-6'
date: '2022-5-23'
readTime: '4 min'
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;经过前几篇文章的讲述，我们的组件库已经初具规模：[源码](https://github.com/heiheihoho1213/dux-ui)。现在我们讲述一下如何发布到npm上，并且配置一下gitee pages.

本文最终部署主页效果：[UI库主页](https://heiheihoho1213.github.io/dux-ui/)。
