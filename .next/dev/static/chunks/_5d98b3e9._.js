...
function BlogClient({ content }) {
    ...
    const allTags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$4_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BlogClient.useMemo[allTags]": ()=>{
            const tags = new Set();
            posts.toSorted({
                "BlogClient.useMemo[allTags]": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
            }["BlogClient.useMemo[allTags]"]).forEach({
                "BlogClient.useMemo[allTags]": (post)=>post.tags.forEach({
                        "BlogClient.useMemo[allTags]": (tag)=>tags.add(tag)
                    }["BlogClient.useMemo[allTags]"])
            }["BlogClient.useMemo[allTags]"]);
            return [
                'ALL',
    ...
    const filteredPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$4_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BlogClient.useMemo[filteredPosts]": ()=>{
            const base = selectedTag === 'ALL' ? posts : posts.filter({
                "BlogClient.useMemo[filteredPosts]": (post)=>post.tags.includes(selectedTag)
            }["BlogClient.useMemo[filteredPosts]"]);
            return [
                ...base
            ].sort({
                "BlogClient.useMemo[filteredPosts]": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
            }["BlogClient.useMemo[filteredPosts]"]);
        }
    }["BlogClient.useMemo[filteredPosts]"], [
        selectedTag,
...
_s(BlogClient, "KZbxb5UpOPzz/ok/c6yulkIh0ZU=", false, function() {
    return [
...
//# sourceMappingURL=_5d98b3e9._.js.map